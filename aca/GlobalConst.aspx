...
var GLOBAL_APPLICATION_ROOT = "/SANDIEGO/";
...
var AMCA_URL = "/SANDIEGO/amca";
var DISABLE_MOBILE_REDIRECT = "False".toLowerCase()=="true";

var getText = new function() {
    this.global_js_showError_title = 'System Message:';
    this.global_js_showError_alt = 'System Message:';
    this.global_js_showError_src = '/SANDIEGO/app_themes/Default/assets/error_24.gif';
    this.global_js_showConfirm_title = 'Confirm message';
    this.global_js_showConfirm_src = '/SANDIEGO/app_themes/Default/assets/confirmation_24.gif';
    this.global_js_showNotice_title = 'Notice';
    this.global_js_showNotice_src = '/SANDIEGO/app_themes/Default/assets/notice_24.gif';
    this.global_js_showLoading_title = 'Please wait...';
    this.global_js_showLoading_src = '/SANDIEGO/app_themes/Default/assets/loading.gif';
    ...
    this.global_js_section_CTreeTop = '/SANDIEGO/app_themes/Default/assets/caret_collapsed.gif';
    this.global_js_section_ETreeTop = '/SANDIEGO/app_themes/Default/assets/caret_expanded.gif';
